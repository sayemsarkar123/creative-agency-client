        ...
        <form onSubmit={handleSubmit(onSubmit)} className="wasValidated">
          ...
          <div className="form-group">
            <input
              ...
              className={`form-control ${
                errors.projectName ? 'is-invalid' : null
              }`}
              ref={register({
                required: {
                  value: true,
          ...
          <div className="form-group">
            <textarea
              ...
              className={`form-control ${
                errors.projectDetails ? 'is-invalid' : null
              }`}
              ref={register({
                required: {
                  value: true,
          ...
          <div className="form-row">
            <div className="col-md-6">
              <input
                ...
                name="price"
                placeholder="Price"
                className={`form-control ${errors.price ? 'is-invalid' : null}`}
                ref={register({
                  required: {
                    value: true,
                    message: 'This field cannot be empty.',
            ...
            <div className="col-md-6">
              ...
              <input
                ...
                className={`form-control-file inputfile ${
                  errors.projectFile ? 'is-invalid' : null
                }`}
                ref={register({
                  required: {
                    value: true,
