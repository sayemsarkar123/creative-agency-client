      ...
      <div className="col-md-8">
        <form onSubmit={handleSubmit(onSubmit)} className="wasValidated">
          ...
          <div className="col-md-9">
            <label>Email</label>
            <input type="email" name="email" placeholder="jon@gamil.com" ref={register({ required: { value: true, message: 'This field cannot be empty.' } })} className={`form-control ${errors.email ? 'is-invalid' : null}`} />
